...
// FromString provides a mock function with given fields: _a0
func (_m *DataSchema) FromString(_a0 string) (interface{}, error) {
	ret := _m.Called(_a0)

	if len(ret) == 0 {
		panic("no return value specified for FromString")
	}
...
func (_m *DataSchema) Validate(_a0 interface{}) error {
	ret := _m.Called(_a0)
