...
func (_m *PropertyWriteHandler) Execute(_a0 producer.ExposedThing, _a1 string, _a2 interface{}, _a3 map[string]interface{}) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(producer.ExposedThing, string, interface{}, map[string]interface{}) error); ok {
